# -*- coding: utf-8 -*-
"""Widget batch, APPROVED 6 Sep 2026 by Cyan.

All 15 reviewed. 14 came back rewritten across two rounds and are applied
VERBATIM; abandoned-pawn-unrivaled-dragon-king she ticked unchanged, which
under READ MEANS DONE is approval.

HER TYPOS ARE LEFT IN, DELIBERATELY, PENDING HER RULING. This batch carries
"Bella in and act of defiance", "The stranger tutns out to be", "her sisters
death". Batch four went live the same way with "Nessa is hides her identity",
"suprisingly" and "bit it's also". The verbatim rule has never had a typo
exception and inventing one silently would be worse than the typos. Asked.
"""
...
CAPTIONS = {
    ...
    'falling-for-my-ex-s-mafia-dad-2':
        'She thought she had this mafia world figured out.\nFay Thompson has learned enough about the mafia to believe she can hold her own in it, and then danger comes at her from three directions at once. A scheming rival moves in, she discovers she is pregnant at the worst time, and her lover is arrested. There is no version of this where she stays who she was. Fay either becomes the Mafia Queen she was always fated to be, or she loses it all.',
    ...
    'the-alpha-princess-is-gone-for-good':
        'Her family thought she was living in comfort.\nEvie is the real alpha princess, and her own family framed her and shipped her off to the Werewolf Military Academy, which is not a place anyone dwells without suffering. They tell themselves she is fine, spoiled even, with no idea that the fake alpha princess has given orders and that Evie is being brutally abused every single day. Three years of it. When she finally comes home she is broken in ways that do not show, so when they look at her they still see a brat who never had to work for anything. It takes her own father striking her, and her prosthetic limb coming loose and falling in front of the whole family, before a single one of them understands what terrible thing they have done to her.',
    ...
    'the-valkyrie-divorces-the-god-of-war':
        "He gave up his godhood for her. She came home pregnant.\nGod King Kairos sealed away his divine power and spent years pretending to be a weak mortal, purely to keep his wife out of danger. Cassia repaid him by coming home carrying another man's baby, then demanded the heirloom his family had kept for generations and made sure the humiliation happened where everyone could see it. Every insult landed on a man who could have ended her with a word and chose not to, for her sake. Then she pushes him past what he can tolerate. Kairos shatters his own shackles, his supreme godhood comes roaring back, and the first thing he does with it is expose her lover as an abyssal spy and watch the traitor executed. Cassia is on her knees begging by the time she is exiled.",
