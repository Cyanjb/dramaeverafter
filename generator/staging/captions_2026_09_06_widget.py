# -*- coding: utf-8 -*-
"""Widget batch, 6 Sep 2026, SECOND PASS.

Cyan on the first pass: "these captions are terrible they seem to be cut
off and just be changing words which are two things I told you not to do,
forget about limiting caption length", quoting "three Masters beyond
Sacred Rank" as the example.

She was right on all three. The count caps came OUT on 24 Aug ("just
remove these word caps") and I reintroduced compression on my own, which
is what made these read cut off, and compressing forced me into swapping
words around the source's own sentences instead of retelling the story.
Her five rewrites here are the reference: 61 to 103 word bodies, the
connective tissue put back ("In a twist of fate he is taken in by three
Masters beyond Sacred Rank who spend two decades training him"), and a
closing beat that lands the feeling rather than stopping at the setup.

Her 5 are VERBATIM. The other 10 are rewritten to that standard: full
arc, nothing lifted, no length target.

Three from the list still need her or a better source:
  first-daughter-forbidden-duty        no platform link on the row
  when-the-wolf-fell-in-love           truncated boilerplate
  the-mafias-stolen-bride-twin-switch  marketing blurb, no story
"""
...
CAPTIONS = {
    ...
    # FACTS: ers as the sky itself begins to change.
    'abandoned-pawn-unrivaled-dragon-king':
        'His family threw away the boy who bonded with a dragon.\nOwen is the discarded heir of the Hull family, taken in as the one and only disciple of the master of the Dragon Knight Sanctum. There he awakens the Ten Dragon God Marks and forms a bond that goes soul deep with Akura, who carries the ancient Golden Dragon bloodline. It should have been the making of him. Instead his own family betray him, strip him of his name, and the Sanctum that was supposed to be his home turns on him and torments him for years. Then the truth they buried finally works its way loose. The outcast they wrote off rises with the full wrath of a Dragon God behind him, grinds every humiliation into dust, and rides out across the continent with Akura at his side while the sky itself begins to change.',
    ...
    'falling-for-my-ex-s-mafia-dad-2':
        'She thought she had this world figured out.\nFay Thompson has learned enough about the mafia to believe she can hold her own in it, and then it comes at her from three directions at once. A scheming rival moves in, a pregnancy lands that she did not plan for, and her lover is arrested and taken out of reach. There is no version of this where she stays who she was. Fay either becomes the Mafia Queen she was always going to be, or she loses Kent Lippert for good.',
    ...
    'honey-trapped-my-fiance-s-billionaire-rival':
        "Ten years of loving him, and he asks her to seduce another man.\nJade Gray has given Ryan a decade, so when he asks her for a favour she listens. The favour is to honey trap his billionaire rival Asher Blackwood, and the reason is Eleanor, Ryan's first love, who needs saving. That is what Jade is worth to him. The part Ryan never accounted for is that Asher already has feelings for her, which turns a carefully built scheme into a love triangle nobody controls. The closer Jade gets to the man she was sent to manipulate, the harder it becomes to keep pretending Ryan is the one who deserves her.",
    ...
    'in-bed-with-my-brother-in-law':
        "Revenge sex with a stranger. He turns out to be family.\nBella's arranged marriage is already a nightmare when she catches her fiance with another woman, so she goes out and sleeps with the first stranger she finds to level the score. The stranger is Damian Gotti, her fiance's brother and the mafia boss the whole family answers to. Dragged back into the Gotti house, Bella is surrounded by secrets that could get her killed and a want she is not allowed to have, and Damian comes after her relentlessly right under his brother's nose. In the end it is Damian who lays his brother's crimes out in the open, Damian who gets her out, and they hold the throne together afterwards.",
    ...
    'my-billionaire-boss-won-t-let-me-quit':
        "She took the job to get away from other people's crises.\nGrace has spent years cleaning up messes that were never hers, so a new job with a new company is supposed to be the quiet part of her life. Her enigmatic boss Mason has other plans, and within weeks she is signed into a fake marriage with him. The pretending does not stay pretend for long. She falls, harder than she means to, and by the time she is deep enough to notice, the arrangement has stopped feeling like an arrangement at all. What Grace still cannot see is how much bigger this is than a fake marriage, or that Mason decided long before he hired her that she would never be leaving.",
    ...
    # FACTS: t world-class chefs, exposing her true identity and sparking a legendary romance.
    'my-homeless-bride-is-a-culinary-legend':
        "Five world titles, and she is out on the street on purpose.\nChef Sage has just taken her fifth World Culinary Championship and has no interest in being loved for it, so she puts on rags and goes undercover as a beggar to find someone with genuine character. Everybody walks past her, and her ex makes a performance of mocking her. Jasper is the one who stops and gives her his food. He is also about to lose his family's restaurant to a vicious corporate takeover, so he hires the beggar he just fed to play his wealthy fake fiancee. When rival factions corner the Vance family into a high stakes Culinary Death Match and there is no way out left, the beggar bride drops the disguise. One flash of her blade, one burst of her signature blue flame, and a room full of world class chefs finds out exactly who they have been standing next to.",
    ...
    'shattered-vows':
        "Her husband helped her sister's killer walk free.\nPrincess Venessa grew up sheltered and stayed that way until the night her sister was murdered, and everything she believed about her own life died alongside her. The betrayal underneath it is the part that guts her. The man she married and the friend she trusted most had both leaned on the scales so the person who did it would never answer for it. Whatever she was before that night, she is not it now. What is left is a woman going after every one of them, one at a time, to collect the justice her sister was owed and never got.",
    ...
    'the-alpha-princess-is-gone-for-good':
        'Her family thought she was living in comfort.\nEvie is the real alpha princess, and her own family framed her and shipped her off to the Werewolf Military Academy, which is not a place anyone survives gently. They tell themselves she is fine, spoiled even, with no idea that the fake alpha princess has given orders and that Evie is being brutally abused on them every single day. Three years of it. When she finally comes home she is broken in ways that do not show, and they look at her and still see a brat who never had to work for anything. It takes her own father striking her, and her prosthetic limb coming loose and falling in front of the whole family, before a single one of them understands what they did to her.',
    ...
    'the-lycan-s-savage-luna':
        "He rejected her at his coronation and let his lover cut her hair.\nWren is labelled wolfless, which is the worst thing you can be called in the Dark Moon pack, and her childhood love Tristan chooses his crowning day to reject their mate bond in front of everyone. Then he stands there while the woman he picked instead takes a blade to Wren's hair. She leaves that night for the elite Apex Academy, and it is there that the rare and powerful White Wolf bloodline hidden inside her finally wakes up. With the quiet Frost heir Killian beside her, Wren beats every rival they put in front of her, drags Vaelen's plot to feed on wolfkin blood power into the open and gets her father out alive. What she builds afterwards is a new order where nobody has to kneel for power again.",
    ...
    'the-valkyrie-divorces-the-god-of-war':
        "He gave up his godhood for her. She came home pregnant.\nGod King Kairos sealed away his divine power and spent years playing a worthless mortal, purely to keep his wife out of danger. Cassia repaid him by coming home carrying another man's baby, then demanded the heirloom his family had kept for generations and made sure the humiliation happened where everyone could see it. Every insult landed on a man who could have ended her with a word and chose not to, for her sake. Then she pushes him past the last of it. Kairos shatters his own shackles, his supreme godhood comes roaring back, and the first thing he does with it is expose her lover as an abyssal spy and watch the traitor executed. Cassia is on her knees begging by the time she flees into exile.",
