...
/* POSTER RATIO IS 3:4 AND STAYS 3:4 (Cyan, 13 Sep 2026: "posters should always
   stay true to their sources"). Measured that day, the platforms ship: ReelShort
   1080x1440, GoodShort 1080x1440, NetShort 651x868, PineDrama 1080x1440 and
   DramaBox 600x800, all 3:4; Vigloo 640x960 and ShortMax 700x1050 are 2:3 and
   Galatea 420x600 is 0.70, so they letterbox slightly rather than being cropped.
   The site was 2:3 until today, which cropped a quarter off the sides of nearly
   every poster, including the artwork's own title. check_site fails the build if
   this moves. */
.poster{display:block;position:relative;aspect-ratio:3/4;background:#F1E6E9;border:1px solid var(--line);border-radius:3px;overflow:hidden}
...
.split-hero .poster-col img{width:100%;aspect-ratio:3/4;object-fit:cover;display:block;border:1px solid var(--line);border-radius:3px}
...
.blog-row .thumb{flex:0 0 auto;width:96px;aspect-ratio:3/4;background:var(--blush);border:1px solid var(--line);border-radius:3px;overflow:hidden}
...
def watch_buttons(title_id, pre=""):
    ...
    #
    # EVERY button carries them, not just the first: since 13 Sep a title on two
    # apps renders a button each, and counting only the first would quietly credit
    # ReelShort for a reader who chose Vigloo. The sticky phone bar reuses the
...
<div class="kv"><div class="k">Email</div><a href="mailto:cyan@dramaeverafter.com">cyan@dramaeverafter.com</a></div>
<div class="kv"><div class="k">Corrections</div><a href="mailto:cyan@dramaeverafter.com?subject=Correction">cyan@dramaeverafter.com</a></div>
</div>
